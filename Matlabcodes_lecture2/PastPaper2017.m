...
syms theta alp a d theta1 theta2 theta3 L1 L2 L3 L4 real
 ...
 DHparam =[0    0   0  theta1;... % Joint 1
           L1  -pi -L2   theta2;... % Joint 2
           0  pi/2    L3    theta3;... % Joint 3
           L4  0    0     0];       % Joint 4
...
%Now we construct the homogeneous transformation matrix
 ...
 tipOrient = acosd(double(BTtip(3,1))) %angle between the x axes of base and z axis of the last link and first link
