...
% the robot starting from the position when all the joints are at their mid range. The circle is give by, x = 0.1*sin(2*pi*1.5*t), z =
% 0.1*cos(2*pi*1.5*t), y  kept constant at initial position, and t is time. Plot for 1 seconds.
